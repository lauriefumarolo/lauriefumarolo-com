	...
	<div id="main" class="container" role="main">
		<div class="cards">
			...
			<div class="card">
				...
				<p><a href="http://cityplanetarium.lauriefumarolo.com" target="_blank" aria-label="View the City Planetarium site">View the Site</a></p>
			...
			<div class="card">
				...
				<p><a href="http://jbaquery.lauriefumarolo.com" target="_blank" aria-label="View the jBaquery site">View the Site</a></p>
				<p><a href="http://bitbucket.org/lcaires2/jbaquery" target="_blank" aria-label="View the jBaquery code repository on BitBucket">View the Code Repository on BitBucket</a></p>
			</div>
		</div>
	</div>
